...
void Adafruit_INA219::setCalibration_32V_12A(void)
{
  ina219_calValue = 4096;
  ina219_currentDivider_mA = 2.5;  // Current LSB = 400uA per bit (1000/400 = 2.5)
  ina219_powerDivider_mW = 0.5;     // Power LSB = 4mW per bit (2/4 = 0.5)
...
int16_t Adafruit_INA219::getBusVoltage_raw() {
  ...
  // always ensure config is set as expected
  //wireWriteRegister(INA219_REG_CONFIG, ina219_configValue);
